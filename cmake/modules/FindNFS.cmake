...
if(NOT TARGET ${APP_NAME_LC}::${CMAKE_FIND_PACKAGE_NAME})
  ...
  if((libnfs_VERSION VERSION_LESS ${${MODULE}_VER} AND ENABLE_INTERNAL_NFS) OR
    ...
    if(TARGET libnfs::nfs)
      ...
      get_target_property(LIBNFS_INCLUDE_DIR libnfs::nfs INTERFACE_INCLUDE_DIRECTORIES)
    else()
  ...
  if(NFS_FOUND)
    ...
    set_target_properties(${APP_NAME_LC}::${CMAKE_FIND_PACKAGE_NAME} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${LIBNFS_INCLUDE_DIR})

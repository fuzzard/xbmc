...
if(NOT TARGET Python::Pycryptodome)
  ...
  macro(buildPythonmodulePycryptodome)
    ...
    set(patches "${CMAKE_SOURCE_DIR}/tools/depends/target/${MODULE_LC}/01-revert-ctype.pythonapi-use.patch"
                "${CMAKE_SOURCE_DIR}/tools/depends/target/${MODULE_LC}/10-win-cmake.patch"
                "${CMAKE_SOURCE_DIR}/tools/depends/target/${MODULE_LC}/11-win-arm64-buildfix.patch")

    if(CORE_SYSTEM_NAME STREQUAL android)
      list(APPEND patches "${CMAKE_SOURCE_DIR}/tools/depends/target/${MODULE_LC}/02-android-dlopen.patch")
    endif()
    ...
    if(${CORE_SYSTEM_NAME} MATCHES "windows")
      ...
      set(BUILD_BYPRODUCTS "${PYTHON_SITE_PKG}/Cryptodome/Cipher/${${MODULE}_BYPRODUCT}")
  ...
  if(PYCRYPTO_VER VERSION_LESS ${${MODULE}_VER})
    ...
    add_dependencies(Python::Pycryptodome ${APP_NAME_LC}::Python)

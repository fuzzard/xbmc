...
if(NOT TARGET LibDvdRead::LibDvdRead)
  ...
  if(PKG_CONFIG_FOUND)
    pkg_check_modules(PC_LIBDVDREAD QUIET)
  endif()

  find_path(LIBDVDREAD_INCLUDE_DIR dvdread/dvd_reader.h
                               PATHS ${PC_LIBDVDREAD_INCLUDEDIR})
  find_library(LIBDVDREAD_LIBRARY_RELEASE NAMES dvdread libdvdread
                                         PATHS ${PC_LIBDVDREAD_LIBDIR})

  set(LIBDVDREAD_VERSION ${PC_LIBDVDREAD_VERSION})

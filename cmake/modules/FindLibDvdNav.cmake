...
if(NOT TARGET LibDvdNav::LibDvdNav)
  ...
  if(PKG_CONFIG_FOUND)
    pkg_check_modules(PC_LIBDVDNAV QUIET)
  endif()

  find_path(LIBDVDNAV_INCLUDE_DIR dvdnav/dvdnav.h
                               PATHS ${PC_LIBDVDNAV_INCLUDEDIR})
  find_library(LIBDVDNAV_LIBRARY_RELEASE NAMES dvdnav libdvdnav
                                         PATHS ${PC_LIBDVDNAV_LIBDIR})

  set(LIBDVDNAV_VERSION ${PC_LIBDVDNAV_VERSION})

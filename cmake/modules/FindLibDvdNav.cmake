...
if(NOT TARGET LIBRARY::${CMAKE_FIND_PACKAGE_NAME})
  ...
  macro(buildmacroLibDvdNav)
    ...
    if(ENABLE_DVD_VFS)
      ...
      set(patches "${CORE_SOURCE_DIR}/tools/depends/target/${${CMAKE_FIND_PACKAGE_NAME}_MODULE_LC}/01-all-dvdnav_open_files.patch")
    endif()

    if(WIN32 OR WINDOWS_STORE)
      set(${${CMAKE_FIND_PACKAGE_NAME}_MODULE}_libType shared)
      list(APPEND patches "${CORE_SOURCE_DIR}/tools/depends/target/${${CMAKE_FIND_PACKAGE_NAME}_MODULE_LC}/02-win-uwpcompat.patch")

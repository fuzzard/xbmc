...
if(ENABLE_DVDCSS)
  ...
  if(PKG_CONFIG_FOUND)
    pkg_check_modules(PC_LIBDVDCSS QUIET)
  endif()

  find_path(LIBDVDCSS_INCLUDE_DIR dvdcss/dvdcss.h
                               PATHS ${PC_LIBDVDCSS_INCLUDEDIR})
  find_library(LIBDVDCSS_LIBRARY_RELEASE NAMES dvdcss libdvdcss
                                         PATHS ${PC_LIBDVDCSS_LIBDIR})

  set(LIBDVDCSS_VERSION ${PC_LIBDVDCSS_VERSION})

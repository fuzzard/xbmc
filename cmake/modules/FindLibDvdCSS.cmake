...
if(ENABLE_DVDCSS)
  ...
  if(LIBDVDCSS_FOUND)
message(FATAL_ERROR "LIBDVDCSS_LIBRARIES: ${LIBDVDCSS_LIBRARIES}")
    # INCLUDE_DIR, VERSION set
    set(LIBDVDCSS_LIBRARY_RELEASE ${LIBDVDCSS_LINK_LIBRARIES})

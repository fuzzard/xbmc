...
if(ENABLE_INTERNAL_FLATBUFFERS)
  ...
  set(FLATBUFFERS_FLATC_EXECUTABLE ${DEPENDS_PATH}/bin/flatc CACHE INTERNAL "FlatBuffer compiler")
  ...
  set_target_properties(build_${MODULE_LC} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${FLATBUFFERS_INCLUDE_DIR})
else()

...
if(NOT TARGET ${APP_NAME_LC}::${CMAKE_FIND_PACKAGE_NAME})
  ...
  macro(buildXSLT)
    ...
    add_dependencies(${${CMAKE_FIND_PACKAGE_NAME}_MODULE_LC} LIBRARY::LibXml2)
  endmacro()
  ...
  if(XSLT_FOUND)
    ...
    elseif(TARGET PkgConfig::libxslt AND NOT TARGET xslt)
      ...
      target_link_libraries(${APP_NAME_LC}::${CMAKE_FIND_PACKAGE_NAME} INTERFACE LIBRARY::LibXml2)
    endif()

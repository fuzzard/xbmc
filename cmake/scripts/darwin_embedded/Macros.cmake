function(core_link_library lib wraplib)
  ...
  elseif(CMAKE_GENERATOR MATCHES "Xcode")
    ...
    # Bracket arguments dont eval any variables/escapes. This allows CURRENT_VARIANT to pass correctly
    set(wrapper_obj [=[cores/dll-loader/exports/kodi.build/$CONFIGURATION$EFFECTIVE_PLATFORM_NAME/wrapper.build/Objects-$CURRENT_VARIANT]=])
    # we need to eval CPU, so append after bracket argument above.
    string(APPEND wrapper_obj "/${CPU}/wrapper.o")
  else()

...
# Unset variables created by cmake_pkg_config(EXTRACT)
# https://cmake.org/cmake/help/latest/command/cmake_pkg_config.html
macro(unset_cmake_pkg_config)
  unset(CMAKE_PKG_CONFIG_NAME)
  unset(CMAKE_PKG_CONFIG_DESCRIPTION)
  unset(CMAKE_PKG_CONFIG_VERSION)
  unset(CMAKE_PKG_CONFIG_PROVIDES)
  unset(CMAKE_PKG_CONFIG_REQUIRES)
  unset(CMAKE_PKG_CONFIG_CONFLICTS)
  unset(CMAKE_PKG_CONFIG_CFLAGS)
  unset(CMAKE_PKG_CONFIG_INCLUDES)
  unset(CMAKE_PKG_CONFIG_COMPILE_OPTIONS)
  unset(CMAKE_PKG_CONFIG_LIBS)
  unset(CMAKE_PKG_CONFIG_LIBDIRS)
  unset(CMAKE_PKG_CONFIG_LIBNAMES)
  unset(CMAKE_PKG_CONFIG_LINK_OPTIONS)
  unset(CMAKE_PKG_CONFIG_CFLAGS_PRIVATE)
  unset(CMAKE_PKG_CONFIG_LIBS_PRIVATE)
  unset(CMAKE_PKG_CONFIG_REQUIRES_PRIVATE)
endmacro()

# DEBUG: print variables from cmake_pkg_config(EXTRACT) as well as scoped
#        variables after scope_cmake_pkg_config_variables() call
macro(print_cmake_pkg_config_variables)
  message(STATUS CMAKE_PKG_CONFIG_NAME: ${CMAKE_PKG_CONFIG_NAME}\n
                 CMAKE_PKG_CONFIG_DESCRIPTION: ${CMAKE_PKG_CONFIG_DESCRIPTION}\n
                 CMAKE_PKG_CONFIG_VERSION: ${CMAKE_PKG_CONFIG_VERSION}\n
                 CMAKE_PKG_CONFIG_PROVIDES: ${CMAKE_PKG_CONFIG_PROVIDES}\n
                 CMAKE_PKG_CONFIG_REQUIRES: ${CMAKE_PKG_CONFIG_REQUIRES}\n
                 CMAKE_PKG_CONFIG_CONFLICTS: ${CMAKE_PKG_CONFIG_CONFLICTS}\n
                 CMAKE_PKG_CONFIG_CFLAGS: ${CMAKE_PKG_CONFIG_CFLAGS}\n
                 CMAKE_PKG_CONFIG_INCLUDES: ${CMAKE_PKG_CONFIG_INCLUDES}\n
                 CMAKE_PKG_CONFIG_COMPILE_OPTIONS: ${CMAKE_PKG_CONFIG_COMPILE_OPTIONS}\n
                 CMAKE_PKG_CONFIG_LIBS: ${CMAKE_PKG_CONFIG_LIBS}\n
                 CMAKE_PKG_CONFIG_LIBDIRS: ${CMAKE_PKG_CONFIG_LIBDIRS}\n
                 CMAKE_PKG_CONFIG_LIBNAMES: ${CMAKE_PKG_CONFIG_LIBNAMES}\n
                 CMAKE_PKG_CONFIG_LINK_OPTIONS: ${CMAKE_PKG_CONFIG_LINK_OPTIONS}\n
                 CMAKE_PKG_CONFIG_CFLAGS_PRIVATE: ${CMAKE_PKG_CONFIG_CFLAGS_PRIVATE}\n
                 CMAKE_PKG_CONFIG_LIBS_PRIVATE: ${CMAKE_PKG_CONFIG_LIBS_PRIVATE}\n
                 CMAKE_PKG_CONFIG_REQUIRES_PRIVATE: ${CMAKE_PKG_CONFIG_REQUIRES_PRIVATE})
  message(STATUS ${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_NAME: ${CMAKE_PKG_CONFIG_NAME}\n
                 ${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_DESCRIPTION: ${CMAKE_PKG_CONFIG_DESCRIPTION}\n
                 ${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_VERSION: ${CMAKE_PKG_CONFIG_VERSION}\n
                 ${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_PROVIDES: ${CMAKE_PKG_CONFIG_PROVIDES}\n
                 ${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_REQUIRES: ${CMAKE_PKG_CONFIG_REQUIRES}\n
                 ${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_CONFLICTS: ${CMAKE_PKG_CONFIG_CONFLICTS}\n
                 ${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_CFLAGS: ${CMAKE_PKG_CONFIG_CFLAGS}\n
                 ${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_INCLUDES: ${CMAKE_PKG_CONFIG_INCLUDES}\n
                 ${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_COMPILE_OPTIONS: ${CMAKE_PKG_CONFIG_COMPILE_OPTIONS}\n
                 ${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_LIBS: ${CMAKE_PKG_CONFIG_LIBS}\n
                 ${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_LIBDIRS: ${CMAKE_PKG_CONFIG_LIBDIRS}\n
                 ${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_LIBNAMES: ${CMAKE_PKG_CONFIG_LIBNAMES}\n
                 ${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_LINK_OPTIONS: ${CMAKE_PKG_CONFIG_LINK_OPTIONS}\n
                 ${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_CFLAGS_PRIVATE: ${CMAKE_PKG_CONFIG_CFLAGS_PRIVATE}\n
                 ${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_LIBS_PRIVATE: ${CMAKE_PKG_CONFIG_LIBS_PRIVATE}\n
                 ${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_REQUIRES_PRIVATE: ${CMAKE_PKG_CONFIG_REQUIRES_PRIVATE})
endmacro()

# Create variables targetted to the Find package from a cmake_pkg_config(EXTRACT) call
macro(scope_cmake_pkg_config_variables)
  set(${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_NAME ${CMAKE_PKG_CONFIG_NAME})
  set(${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_DESCRIPTION ${CMAKE_PKG_CONFIG_DESCRIPTION})
  set(${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_VERSION ${CMAKE_PKG_CONFIG_VERSION})
  set(${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_PROVIDES ${CMAKE_PKG_CONFIG_PROVIDES})
  set(${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_REQUIRES ${CMAKE_PKG_CONFIG_REQUIRES})
  set(${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_CONFLICTS ${CMAKE_PKG_CONFIG_CONFLICTS})
  set(${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_CFLAGS ${CMAKE_PKG_CONFIG_CFLAGS})
  set(${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_INCLUDES ${CMAKE_PKG_CONFIG_INCLUDES})
  set(${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_COMPILE_OPTIONS ${CMAKE_PKG_CONFIG_COMPILE_OPTIONS})
  set(${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_LIBS ${CMAKE_PKG_CONFIG_LIBS})
  set(${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_LIBDIRS ${CMAKE_PKG_CONFIG_LIBDIRS})
  set(${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_LIBNAMES ${CMAKE_PKG_CONFIG_LIBNAMES})
  set(${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_LINK_OPTIONS ${CMAKE_PKG_CONFIG_LINK_OPTIONS})
  set(${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_CFLAGS_PRIVATE ${CMAKE_PKG_CONFIG_CFLAGS_PRIVATE})
  set(${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_LIBS_PRIVATE ${CMAKE_PKG_CONFIG_LIBS_PRIVATE})
  set(${CMAKE_FIND_PACKAGE_NAME}_PKG_CONFIG_REQUIRES_PRIVATE ${CMAKE_PKG_CONFIG_REQUIRES_PRIVATE})
endmacro()

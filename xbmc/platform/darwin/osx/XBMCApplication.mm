...
- (void)setupWorkingDirectory
{
  ...
  NSString* mainPath = [bundlePath stringByDeletingLastPathComponent];

  assert(chdir(mainPath.UTF8String) == 0); /* chdir to the binary app's parent */
}
...
int main(int argc, char* argv[])
{
  @autoreleasepool
  {
    ...
    // Set App Delegate
    [NSApp setDelegate:[XBMCDelegate new]];

...
void CPVRManager::TriggerTimersUpdate(int clientId)
{
  ...
  m_pendingUpdates->Append("pvr-update-timers",
                           [this, &clients]() { return Timers()->UpdateFromClients(clients); });
}

void CPVRManager::TriggerTimersUpdate()
{
  m_pendingUpdates->Append("pvr-update-timers",
                           [this]() { return Timers()->UpdateFromClients({}); });
}
...
void CPVRManager::TriggerProvidersUpdate(int clientId)
{
  ...
  m_pendingUpdates->Append("pvr-update-channel-providers",
                           [this, &clients]() { return Providers()->UpdateFromClients(clients); });
}

void CPVRManager::TriggerProvidersUpdate()
{
  m_pendingUpdates->Append("pvr-update-channel-providers",
                           [this]() { return Providers()->UpdateFromClients({}); });
}
...
void CPVRManager::TriggerChannelsUpdate(int clientId)
{
  ...
  m_pendingUpdates->Append("pvr-update-channels", [this, &clients]() {
    return ChannelGroups()->UpdateFromClients(clients, true);
  });
}
...
void CPVRManager::TriggerChannelsUpdate()
{
  m_pendingUpdates->Append("pvr-update-channels", [this]() {
    return ChannelGroups()->UpdateFromClients({}, true);
  });
}
...
void CPVRManager::TriggerChannelGroupsUpdate(int clientId)
{
  ...
  m_pendingUpdates->Append("pvr-update-channelgroups", [this, &clients]() {
    return ChannelGroups()->UpdateFromClients(clients, false);
  });
}
...
void CPVRManager::TriggerChannelGroupsUpdate()
{
  m_pendingUpdates->Append("pvr-update-channelgroups", [this]() {
    return ChannelGroups()->UpdateFromClients({}, false);
  });
}

...
void CExternalPlayer::Process()
{
  ...
  if (!m_filenameReplacers.empty())
  {
    ...
    {
      std::vector<std::string> vecSplit = KODI::StringUtils::Split(m_filenameReplacers[i], " , ");
      ...
      KODI::StringUtils::Replace(strMatch, ",,",",");
      ...
      if (regExp.RegFind(mainFile) > -1)
      {
        ...
        KODI::StringUtils::Replace(strPat, ",,",",");
        ...
        KODI::StringUtils::Replace(strRep, ",,",",");
  ...
  if (KODI::StringUtils::EndsWith(m_filename, ".bat") || KODI::StringUtils::EndsWith(m_filename, ".cmd"))
  {
  ...
  int nReplaced = KODI::StringUtils::Replace(strFArgs, "{0}", mainFile);

  if (!nReplaced)
    nReplaced = KODI::StringUtils::Replace(strFArgs, "{1}", mainFile) + KODI::StringUtils::Replace(strFArgs, "{2}", archiveContent);
...
bool CExternalPlayer::Initialize(TiXmlElement* pConfig)
{
  ...
  if (!XMLUtils::GetBoolean(pConfig, "hideconsole", m_hideconsole))
  {
    ...
    m_hideconsole = KODI::StringUtils::EndsWith(m_filename, ".bat");
#endif
  }
                                               ...
                                               std::vector<std::string>& settings)
{
  ...
  if ((szAppend && KODI::StringUtils::CompareNoCase(szAppend, "yes") == 0))
    iAction = 1;
  ...
  while (pReplacer)
  {
    if (pReplacer->FirstChild())
    {
      ...
      bool bGlobal = szGlobal && KODI::StringUtils::CompareNoCase(szGlobal, "true") == 0;
      bool bStop = szStop && KODI::StringUtils::CompareNoCase(szStop, "true") == 0;

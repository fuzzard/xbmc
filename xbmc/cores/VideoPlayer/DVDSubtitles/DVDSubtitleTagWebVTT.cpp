...
CDVDSubtitleTagWebVTT::~CDVDSubtitleTagWebVTT()
{
  delete m_tags;
  delete m_tagOptions;
}

bool CDVDSubtitleTagWebVTT::Init()
{
  delete m_tags;
  delete m_tagOptions;
...
void CDVDSubtitleTagWebVTT::ConvertLine(CDVDOverlayText* pOverlay, const char* line, int len, const char* lang)
{
  std::string strUTF8;
...
void CDVDSubtitleTagWebVTT::CloseTag(CDVDOverlayText* pOverlay)
{
  if (m_flag[FLAG_BOLD])
  {
...
/* @TODO underline?
  ...
  {
    pOverlay->AddElement(new CDVDOverlayText::CElementText("[/U]"));
    m_flag[FLAG_UNDERLINE] = false;
  }
*/
/*
...
void CDVDSubtitleTagWebVTT::LoadHead(CDVDSubtitleStream* samiStream)
{
/*
  char cLine[1024];
  bool inSTYLE = false;

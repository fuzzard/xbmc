...
bool CSkinGUIInfo::GetBool(bool& value, const CGUIListItem *gitem, int contextWindow, const CGUIInfo &info) const
{
  switch (info.m_info)
  {
    ...
    {
      value = KODI::StringUtils::EqualsNoCase(CSkinSettings::GetInstance().GetString(info.GetData1()), info.GetData3());
      return true;
    }
    case SKIN_STRING:
    {
    ...
    case SKIN_HAS_THEME:
    {
      ...
      value = KODI::StringUtils::EqualsNoCase(theme, info.GetData3());
      return true;
    }

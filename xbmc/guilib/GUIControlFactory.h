...
public:
  ...
  static bool GetAspectRatio(const tinyxml2::XMLNode* rootNode,
                             const char* strTag,
                             CAspectRatio& aspectRatio);
  static bool GetInfoTexture(const tinyxml2::XMLNode* rootNode,
                             const char* strTag,
                             CTextureInfo& image,
                             KODI::GUILIB::GUIINFO::CGUIInfoLabel& info,
                             int parentID);
  static bool GetTexture(const tinyxml2::XMLNode* rootNode,
                         const char* strTag,
                         CTextureInfo& image);
  static bool GetAlignment(const tinyxml2::XMLNode* rootNode,
                           const char* strTag,
                           uint32_t& dwAlignment);
  static bool GetAlignmentY(const tinyxml2::XMLNode* rootNode,
                            const char* strTag,
                            uint32_t& dwAlignment);
  ...
  static bool GetInfoLabelFromElement(const tinyxml2::XMLElement* element,
                                      ...
                                      int parentID);
  static void GetInfoLabel(const tinyxml2::XMLNode* controlNode,
                           const std::string& labelTag,
                           KODI::GUILIB::GUIINFO::CGUIInfoLabel& infoLabel,
                           int parentID);
  static void GetInfoLabels(const tinyxml2::XMLNode* controlNode,
                            const std::string& labelTag,
                            std::vector<KODI::GUILIB::GUIINFO::CGUIInfoLabel>& infoLabels,
                            int parentID);
  static bool GetColor(const tinyxml2::XMLNode* rootNode,
                       const char* strTag,
                       UTILS::COLOR::Color& value);
  static bool GetInfoColor(const tinyxml2::XMLNode* rootNode,
                           const char* strTag,
  ...
  static bool GetActions(const tinyxml2::XMLNode* node, const char* strTag, CGUIAction& actions);
  static void GetRectFromString(const std::string &string, CRect &rect);
  static bool GetHitRect(const tinyxml2::XMLNode* rootNode, CRect& rect, const CRect& parentRect);
  static bool GetScroller(const tinyxml2::XMLNode* controlNode,
                          const std::string& scrollerTag,
                          CScroller& scroller);

private:
  static std::string GetType(const tinyxml2::XMLElement* pControlNode);
  static bool GetMovingSpeedConfig(const tinyxml2::XMLNode* rootNode,
                                   const char* strTag,
  ...
  bool GetString(const tinyxml2::XMLNode* rootNode, const char* strTag, std::string& strString);
  static bool GetFloatRange(const tinyxml2::XMLNode* rootNode,
                            const char* strTag,
                            float& iMinValue,
                            float& iMaxValue,
                            float& iIntervalValue);
  static bool GetIntRange(const tinyxml2::XMLNode* rootNode,
                          const char* strTag,
                          int& iMinValue,
                          int& iMaxValue,
                          int& iIntervalValue);
